...
if __name__ == "__main__":
    ...
    multimodel = PPO2(CnnLstmPolicy, multienv, verbose=1, gamma=args.gamma, learning_rate=args.learning_rate)
    multimodel.learn(total_timesteps=args.num_timesteps)
    multimodel.save('models/ppo/cnnlstm/cnnlstmmodel')
