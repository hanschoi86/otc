...
def make_env(log_dir, cpu):
    ...
    def _init():
        env = ObstacleTowerEnv('./ObstacleTower/obstacletower', worker_id=seed+cpu,
                               retro=True, config={'starting-floor': 7, 'total-floors': 11}, greyscale=True, timeout_wait=600)
...
if __name__ == "__main__":
    ...
    multimodel = multimodel.load('models/ppo/multimodel2', multienv)
    multimodel.learn(total_timesteps=args.num_timesteps)
    multimodel.save('models/ppo/seven/sevenmodel')
