...
def make_env(log_dir, cpu):
    ...
    def _init():
        env = ObstacleTowerEnv('./ObstacleTower/obstacletower', worker_id=seed+cpu,
                               retro=True, config={'starting-floor': 10, 'total-floors': 15}, greyscale=True, timeout_wait=600)
...
if __name__ == "__main__":
    ...
    multimodel.save('models/ppo/tenth/tenthmodel')
