...
def get_args():
    ...
    parser.add_argument('--save-interval', type=int, default=175,
    ...
    parser.add_argument('--save-dir', default='default_models',
                        help='Directory to save agent logs (default: default_models)')
    parser.add_argument('--recurrent-policy', action='store_true', default=False,
                        help='Use a recurrent policy')

    parser.add_argument('--env-name', default='otc')
    parser.add_argument('--terminate', default=True)
    parser.add_argument('--terminate-steps', default=1200000)
    parser.add_argument('--load-rms', default=True)
